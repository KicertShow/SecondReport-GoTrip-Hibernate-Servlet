...
public class Edit_view_pro extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String add = request.getParameter("prod_no");
		int prod_no = Integer.parseInt(add);
...
//		model.View p = new model.view_prod();
		ViewBean p = new ViewBean(prod_name,prod_Intro,open_week,open_time,end_time
				,phone,Country,City,Location,address,price);
//		model.ViewBean p = new model.ViewBean();
