	                                	...
	                                	<div class="col-sm-9">
		                                 	<div class="row">        
        										<label for="imagesFromDB"></label>
        											<input type="hidden" name="image1" value="<%=comment.getImage1()%>">
        											<input type="hidden" name="image2" value="<%=comment.getImage2()%>">
        											<input type="hidden" name="image3" value="<%=comment.getImage3()%>">
													<% 	
													int sum = 0;
													...
													%>
														<div class="col-4">
															<input type="checkbox" name="deleteImages" value="image1" id="">刪除
															<img src="images\<%=comment.getImage1()%>" class="rounded" />
														</div>
													<% 
													} 
													...
													%>
														<div class="col-4">
															<input type="checkbox" name="deleteImages" value="image2" id="">刪除
															<img src="images\<%=comment.getImage2()%>" class="rounded" />
														</div>
													<% 
													} 
													...
													%>
														<div class="col-4">
															<input type="checkbox" name="deleteImages" value="image3" id="">刪除
															<img src="images\<%=comment.getImage3()%>" class="rounded" />
														</div>
													<%
													} 
													%>
